...
/**
 * Handles requestuests for the application home page.
 */
@Controller
public class BoardController {
   ...
   public String inputReply(HttpServletRequest requestuest, HttpServletResponse response) throws Exception {
      requestuest.setCharacterEncoding("UTF-8");
   ...
   public int getStoryCount(@RequestParam("id") String id, HttpServletRequest requestuest, HttpServletResponse response)
         throws Exception {
   ...
   public String getStoryList(@RequestParam("id") String id, HttpServletRequest requestuest, HttpServletResponse response)
         throws Exception {
      ...
      requestuest.setAttribute("list", list);
      return "table2";
   }
