...
function getInfo(contentid){
	...
	$('#save').click(function(){
		...
		$.ajax({
			url:'inputBoard.do',
			type:'POST',
			data:{story_seq:story_seq, title:title, content:content, writer:id, mtitle:mtitle, contentId:contentId, star:starvalue, board_seq:board_seq},
